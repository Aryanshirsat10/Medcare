...
<html lang="en">
  ...
  <a class="navbar-brand" href="Patient.html"><i class="fa fa-user-plus" aria-hidden="true"></i>Medcare</a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #129d41, #00ff95);
}
.list-group-item.active {
    z-index: 2;
    color: #fff;
    background-color: #129d41;
    border-color: #129d41;
}
.text-primary {
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="index.html"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>
      </li>
       <li class="nav-item">
